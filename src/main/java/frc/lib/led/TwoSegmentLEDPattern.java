...
public class TwoSegmentLEDPattern implements LEDPattern {
    ...
    public TwoSegmentLEDPattern(LEDPattern pattern1, LEDPattern pattern2, int n1Inclusive, int n2Exclusive, int n3Inclusive, int n4Exclusive, boolean invertSecondSegment) {
    ...
    public Color get(int led, double time) {
        ...
        else if (led >= n3Inclusive && led < n4Exclusive) return pattern2.get(invertSecondSegment ? (n4Exclusive-led+1) : (led-n3Inclusive), time);
