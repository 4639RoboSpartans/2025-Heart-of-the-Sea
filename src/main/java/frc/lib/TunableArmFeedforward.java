...
public class TunableArmFeedforward implements ProtobufSerializable, StructSerializable {
    ...
    /**
     * Creates a new TunableArmFeedforward with the specified gains and period.
     *
    ...
    /**
     * Creates a new TunableArmFeedforward with the specified gains. The period is defaulted to 20 ms.
     *
     * @param ks The static gain in volts.
     * @param kg The gravity gain in volts.
     * @param kv The velocity gain in V/(rad/s).
