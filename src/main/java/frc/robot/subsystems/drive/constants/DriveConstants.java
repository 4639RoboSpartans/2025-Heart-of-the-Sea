...
public class DriveConstants {
    ...
    public static final PIDConstants AUTON_TRANSLATION_PID_CONSTANTS = new PIDConstants(2, 0, 0);
    public static final PIDConstants AUTON_ROTATION_PID_CONSTANTS = new PIDConstants(6, 0, 0);
